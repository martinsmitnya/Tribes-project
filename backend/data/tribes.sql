...
--
-- Host: localhost    Database: tribes
-- ------------------------------------------------------
...
CREATE TABLE `buildings` (
  ...
  `finished_at` varchar(256) NOT NULL,
...
CREATE TABLE `kingdoms` (
  ...
  `kingdom_name` varchar(256) NOT NULL,
...
-- Dump completed on 2021-02-23 15:15:53
