...
export const registerService = {
    async postRegister(username, passwordhash, kingdom_name) {
      ...
      const checkIfKingdomNameisValid = await kingdomRepository.getKingdomByKingdomName(kingdom_name);
     ...
     const newKingdom = await kingdomRepository.insertKingdom(kingdom_name,userId);

     const data = {status: 200, id: userId, username: username, kingdomId: newKingdom}
     return (data);
    },
};